...
export default function FeaturesPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "View statistics about your cards, including expiry dates and distribution.",
    },
  ]
  ...
  const securityFeatures = [
    ...
    },
    {
      ...
      description: "Application prevents screenshots and screen recording for added security.",
    },
    {
      icon: <Fingerprint className="h-5 w-5" />,
      title: "Lockout Protection",
      description: "Multiple failed PIN attempts will temporarily lock access to your cards.",
    },
    {
      icon: <Cloud className="h-5 w-5" />,
      title: "Secure Cloud Storage",
      description: "Your encrypted data is stored in a secure cloud database with multiple layers of protection.",
    },
  ]

  const whyUseCardSaver = [
    {
      icon: <Smartphone className="h-5 w-5" />,
      title: "Access Anywhere",
      description: "Access your cards from any device with an internet connection.",
    },
    {
      icon: <Clock className="h-5 w-5" />,
      title: "Save Time",
      description: "No more searching through your wallet or purse for the right card.",
    },
    {
      icon: <AlertTriangle className="h-5 w-5" />,
      title: "Prevent Loss",
      description: "If you lose your physical cards, you'll still have all the details securely stored.",
    },
    {
      icon: <User className="h-5 w-5" />,
      title: "Personal Organization",
      description: "Keep all your cards organized in one secure place with custom categories.",
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-100 to-red-100 dark:from-purple-900 dark:via-blue-800 dark:to-red-900">
      ...
      <header className="container mx-auto px-4 py-6 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Card Saver</h1>
        </div>
          ...
          <div className="md:w-1/2 mb-10 md:mb-0">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <p className="text-xl mb-8 text-gray-800 dark:text-white">
                Card Saver provides a secure, convenient way to store and manage all your payment cards in one place.
              </p>
          ...
          <div className="text-center mb-16">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800 dark:text-white">
                Why <span className="text-purple-600">Card Saver</span> is Essential
              </h2>
              <p className="text-xl max-w-2xl mx-auto text-gray-800 dark:text-white">
                Card Saver solves common problems and makes managing your cards easier than ever.
              </p>
            </motion.div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyUseCardSaver.map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                viewport={{ once: true }}
              >
                <Card className="p-6 h-full bg-white/90 dark:bg-black/20 text-gray-800 dark:text-white border border-purple-500/20">
                ...
                <div className="space-y-6">
                  {securityFeatures.slice(0, 3).map((feature, index) => (
                    ...
                    >
                      ...
                      <div>
                        <h3 className="text-lg font-bold mb-1 text-gray-800 dark:text-white">{feature.title}</h3>
                        <p className="text-gray-600 dark:text-gray-300">{feature.description}</p>
                      </div>
                    </motion.div>
                  ))}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-6 md:mb-0">
              <img src="/logo.png" alt="Card Saver Logo" className="h-10 mr-2" />
              <div>
                <h3 className="text-xl font-bold text-gray-800 dark:text-white">Card Saver</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">Developed by Mohammed Maaz A</p>
              </div>
            </div>
            <div className="flex items-center space-x-6">
              <Link
                ...
                className="text-gray-800 dark:text-white hover:text-purple-600 transition-colors"
              >
                Support & Feedback
              </Link>
              <Link
